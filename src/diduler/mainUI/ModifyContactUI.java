...
public class ModifyContactUI extends JFrame {
	...
	public ModifyContactUI(String str[],JTable wholeTable,JTable defaultTable,JTable friendTable,JTable familyTable,JTable jobTable) 
	{
	...
	private void initComponents(String str[]) {
		...
		dayComboBox.setModel(new DefaultComboBoxModel(new String[] { "1", "2",
		...
		Person person = new Person(str[0],str[1],str[2],str[3]);
		conController.setPersonInfo(person,str[4]);
		StringTokenizer stk1 = new StringTokenizer(str[1],"@",false);
		StringTokenizer stk2 = new StringTokenizer(str[2],"-",false);
		StringTokenizer stk3 = new StringTokenizer(str[3],"월 ",false);
		nameField.setText(str[0]);
        emailField1.setText(stk1.nextToken());
		emailField2.setText(stk1.nextToken());
		phoneField1.setText(stk2.nextToken());
		phoneField2.setText(stk2.nextToken());
		phoneField3.setText(stk2.nextToken());
		monthComboBox.setSelectedItem(stk3.nextToken());
		dayComboBox.setSelectedItem(stk3.nextToken().charAt(0)+"");
		
		groupComboBox.setSelectedItem(str[4]);
	...
	private class ButtonListener implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent e) 
		{
			...
			if ("수정".equals(e.getActionCommand())) // 수정버튼
			{
				
				conController.modify(nameField.getText(), emailField1.getText()+"@"+ emailField2.getText(),
